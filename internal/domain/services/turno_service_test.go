...
func TestTurnoService_CreateTurno(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			asserts: func(t *testing.T, turno *entities.Turno, err error) {
				...
				assert.Equal(t, entities.EstadoPendiente, turno.Estado)
			},
		},
		{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			turno, err := service.CreateTurno(context.Background(), tt.req)
...
func TestTurnoService_GetTurnoByID(t *testing.T) {
	tests := []struct {
		name     string
		id       int64
		behavior func(m *MockTurnoRepository)
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			service := NewTurnoService(mockRepo)
			turno, err := service.GetTurnoByID(context.Background(), tt.id)
...
func TestTurnoService_GetTurnos(t *testing.T) {
	tests := []struct {
		name     string
		...
		{
			name: "success - returns turnos with default limit",
			filter: &entities.TurnoFilter{
				Limit:  0,
				Offset: 0,
			},
			behavior: func(m *MockTurnoRepository) {
				m.On("GetAll", mock.Anything, mock.MatchedBy(func(f *entities.TurnoFilter) bool {
					return f.Limit == 10
				})).Return([]*entities.TurnoConDetalles{
		...
		{
			name: "success - returns turnos with custom limit",
			filter: &entities.TurnoFilter{
				Limit:  20,
				Offset: 10,
			},
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			service := NewTurnoService(mockRepo)
			turnos, err := service.GetTurnos(context.Background(), tt.filter)
...
func TestTurnoService_CancelTurno(t *testing.T) {
	tests := []struct {
		name     string
		id       int64
		motivo   string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			service := NewTurnoService(mockRepo)
			err := service.CancelTurno(context.Background(), tt.id, tt.motivo)
...
func TestTurnoService_DeleteTurno(t *testing.T) {
	tests := []struct {
		name     string
		id       int64
		behavior func(m *MockTurnoRepository)
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			service := NewTurnoService(mockRepo)
			err := service.DeleteTurno(context.Background(), tt.id)
...
func TestTurnoService_GetProximosTurnosAlert(t *testing.T) {
	tests := []struct {
		name     string
		behavior func(m *MockTurnoRepository)
		...
		{
			name: "success - returns alert with turnos",
			behavior: func(m *MockTurnoRepository) {
				...
				m.On("GetTurnosSinConfirmar", mock.Anything).Return([]*entities.TurnoConDetalles{
					{Turno: entities.Turno{ID: 3}, PacienteNombre: "Patient 3"},
				}, nil)
			},
			asserts: func(t *testing.T, alert *entities.ProximosTurnosAlert, err error) {
				assert.NoError(t, err)
				assert.NotNil(t, alert)
				assert.Equal(t, 2, alert.Count24h)
				assert.Equal(t, 1, alert.CountSinConfirmar)
			},
		},
		{
			name: "error - GetProximosTurnos fails",
			behavior: func(m *MockTurnoRepository) {
				m.On("GetProximosTurnos", mock.Anything, 24).Return(nil, errors.New("database error"))
			},
			asserts: func(t *testing.T, alert *entities.ProximosTurnosAlert, err error) {
				assert.Error(t, err)
				assert.Nil(t, alert)
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			service := NewTurnoService(mockRepo)
			alert, err := service.GetProximosTurnosAlert(context.Background())
...
func (m *MockTurnoRepository) Create(ctx context.Context, turno *entities.Turno) (*entities.Turno, error) {
...
func (m *MockTurnoRepository) GetByID(ctx context.Context, id int64) (*entities.TurnoConDetalles, error) {
...
func (m *MockTurnoRepository) GetAll(ctx context.Context, filter *entities.TurnoFilter) ([]*entities.TurnoConDetalles, error) {
...
func (m *MockTurnoRepository) Update(ctx context.Context, id int64, turno *entities.Turno) (*entities.Turno, error) {
...
func (m *MockTurnoRepository) CancelTurno(ctx context.Context, id int64, motivo string) error {
	args := m.Called(ctx, id, motivo)
	return args.Error(0)
}

func (m *MockTurnoRepository) Delete(ctx context.Context, id int64) error {
	args := m.Called(ctx, id)
	return args.Error(0)
}

func (m *MockTurnoRepository) GetByDia(ctx context.Context, fecha time.Time, contactologoID *int64) ([]*entities.TurnoConDetalles, error) {
...
func (m *MockTurnoRepository) GetBySemana(ctx context.Context, fechaInicio time.Time, contactologoID *int64) ([]*entities.TurnoConDetalles, error) {
...
func (m *MockTurnoRepository) GetByProfesional(ctx context.Context, contactologoID int64, fechaDesde, fechaHasta time.Time) ([]*entities.TurnoConDetalles, error) {
...
func (m *MockTurnoRepository) GetProximosTurnos(ctx context.Context, horasAnticipacion int) ([]*entities.TurnoConDetalles, error) {
...
func (m *MockTurnoRepository) GetTurnosSinConfirmar(ctx context.Context) ([]*entities.TurnoConDetalles, error) {
	args := m.Called(ctx)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
...
func (m *MockTurnoRepository) CheckDisponibilidad(ctx context.Context, contactologoID int64, fechaHora time.Time, duracionMinutos int, excludeTurnoID *int64) (bool, error) {
	args := m.Called(ctx, contactologoID, fechaHora, duracionMinutos, excludeTurnoID)
	return args.Bool(0), args.Error(1)
}

func (m *MockTurnoRepository) Count(ctx context.Context, filter *entities.TurnoFilter) (int, error) {
	args := m.Called(ctx, filter)
